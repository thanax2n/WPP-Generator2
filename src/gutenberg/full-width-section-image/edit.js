...
export default function edit({ attributes, setAttributes }) {
	...
	return [
						...
						<div className='mx-media-button-wrapper'>

							{
								attributes?.sideImageUrl ?
									(<div className="mxsfwn-cover-image-wrapper">
		...
		>
			...
			<div className="wp-block-mxsfwn-full-width-section-image--image-wrapper">

				<img src={attributes.sideImageUrl} data-side-image-id={attributes.sideImageId} alt="" className="mx-side-img" />

			</div>

			<div className="wp-block-mxsfwn-full-width-section-image--content-wrapper">
				<div className="wp-block-mxsfwn-full-width-section-image--text">
					<InnerBlocks />
				</div>
			</div>
