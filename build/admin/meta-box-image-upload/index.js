...
/* harmony import */ var _features_makePostRequest__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../features/makePostRequest */ "./src/admin/meta-box-image-upload/features/makePostRequest.js");
/* harmony import */ var _features_makeGetRequest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../features/makeGetRequest */ "./src/admin/meta-box-image-upload/features/makeGetRequest.js");
...
var ImageUploader = function ImageUploader(_ref) {
  var postMetaKey = _ref.postMetaKey,
    postId = _ref.postId,
    postMetaValue = _ref.postMetaValue;
  ...
  var getSavedImage = function getSavedImage() {
    ...
    (0,_features_makeGetRequest__WEBPACK_IMPORTED_MODULE_2__.makeGetRequest)(postId, postMetaKey).then(function (res) {
      console.log(res);
  ...
  var openFrame = function openFrame(e) {
    ...
    frame.on('select', function () {
      ...
      (0,_features_makePostRequest__WEBPACK_IMPORTED_MODULE_1__.makePostRequest)(postId, attributes).then(function (res) {
        if (res.status === 200) {
          setImageId(imageId);
...
/***/ "./src/admin/meta-box-image-upload/features/makeGetRequest.js":
/*!********************************************************************!*\
  !*** ./src/admin/meta-box-image-upload/features/makeGetRequest.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   makeGetRequest: () => (/* binding */ makeGetRequest)
/* harmony export */ });
...
var makeGetRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(postId, postMetaKey) {
    var encodedMetaKey;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
           ...
           * */
          _context.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('/wp-json/wpp-generator/v1/get-post-meta', {
            params: {
              post_id: postId
  ...
  return function makeGetRequest(_x, _x2) {
...
/***/ "./src/admin/meta-box-image-upload/features/makePostRequest.js":
/*!*********************************************************************!*\
  !*** ./src/admin/meta-box-image-upload/features/makePostRequest.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/wp-json/wpp-generator/v1/post-id/".concat(postId), {
