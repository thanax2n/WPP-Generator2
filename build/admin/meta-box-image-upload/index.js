...
/* harmony import */ var _features_MakeRequest__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../features/MakeRequest */ "./src/admin/meta-box-image-upload/features/MakeRequest.js");
...
var ImageUploader = function ImageUploader(_ref) {
  ...
  var openFileInput = function openFileInput(e) {
    ...
    frame.on('select', function () {
      ...
      (0,_features_MakeRequest__WEBPACK_IMPORTED_MODULE_1__.makeRequest)(postId, attributes).then(function (res) {
        if (res.status === 200) {
          setImageId(imageId);
...
/***/ "./src/admin/meta-box-image-upload/features/MakeRequest.js":
/*!*****************************************************************!*\
  !*** ./src/admin/meta-box-image-upload/features/MakeRequest.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
